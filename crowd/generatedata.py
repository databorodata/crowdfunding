    ...
    with app.app_context():
        with app.test_request_context('/'):
            for i in range(1, 500):
                ...
                topic_for_user = set()
                for _ in range(nums_topic):
                    topic_for_user.add(choice(topic_list))
                ...
                new_user = User(username=username,
                                ...
                                profession=[choice((
                                    'copyrighter', 'videographer', 'director', 'scriptwriter',
                ...
                for _ in range(nums_site):
                    site_for_project.add(choice(sites))
                ...
                topic_blog = [choice(([
                    'fitness', 'travel', 'fashion', 'finance', 'health',
                    'technology', 'family', 'home', 'books', 'arts',
                    'education', 'garden', 'games', 'crafts'
                ]))]
                ...
                if copyrighter:
                    salary_copyrighter = randrange(11000, 26000)

                videographer, salary_videographer = randrange(2), 0
                if videographer:
                    salary_videographer = randrange(11000, 26000)

                director, salary_director = randrange(2), 0
                if director:
                    salary_director = randrange(11000, 26000)

                scriptwriter, salary_scriptwriter = randrange(2), 0
                if scriptwriter:
                    salary_scriptwriter = randrange(11000, 26000)

                graphicdesigner, salary_graphicdesigner = randrange(2), 0
                if graphicdesigner:
                    salary_graphicdesigner = randrange(11000, 26000)

                producer, salary_producer = randrange(2), 0
                if producer:
                    salary_producer = randrange(11000, 26000)

                soundengineer, salary_soundengineer = randrange(2), 0
                if soundengineer:
                    salary_soundengineer = randrange(11000, 26000)

                lightingtechnician, salary_lightingtechnician = randrange(2), 0
                if lightingtechnician:
                    salary_lightingtechnician = randrange(11000, 26000)

                seospecialist, salary_seospecialist = randrange(2), 0
                if seospecialist:
                    salary_seospecialist = randrange(11000, 26000)

                communitymanager, salary_communitymanager = randrange(2), 0
                if communitymanager:
                    salary_communitymanager = randrange(11000, 26000)

                monetizationspecialist, salary_monetizationspecialist = randrange(2), 0
                if monetizationspecialist:
                    salary_monetizationspecialist = randrange(11000, 26000)
                ...
                generating_data = {
                    ...
                    'salary_monetizationspecialist': salary_monetizationspecialist
                }
