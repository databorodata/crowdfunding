...
class CalculateProject:
    ...
    def __init__(self, form):
        ...
        self._salary_all_professionals = None
        self._salary_follower = None
    ...
    def get_salary_follower(self):
        ...
        ratio_moths -= (self._optimal_count_months - self.form.work_plan.count_months) / 10
        ratio_sites -= (self._optimal_count_sites - len(self.form.work_plan.placement_sites)) / 10
        ratio_posts -= (self._optimal_count_posts - self.form.work_plan.count_posts) / 20
    ...
    def get_salary_professionals(self):
        salary_all_professionals = 0
        months = self.form.work_plan.count_months
        step, one_professional = False, 0
        for v in self.form.team_project.values():
            if step:
    ...
    def get_count_and_price_product(self):
        ...
        cost_price = self.form.support_product.price_author
